...
CAFE
  ...
  <link href="main/css/bootstrapp1.css" rel="stylesheet">
...
<?php 
    if(isset($_GET['pesan'])){
        $pesan = $_GET['pesan'];
        if($pesan == "berhasil"){
            echo "<script>alert('Berhasil Registrasi. Silahkan Login menggunakan akun anda!'); window.location = 'index.php'</script>";
        } 
    }
?>
...
<form action="login.php" method="post">
			...
			<font style=" font:bold 24px 'Aleo'; text-shadow:1px 1px 15px #000; color:#000;"><center>CAFE</center></font>
		<br>
