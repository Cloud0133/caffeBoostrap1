...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Inventaris Barang</a>                </li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Inventaris Barang
			</div>
<br>
...
<input type="text" style="padding:15px;" name="filter" value="" id="filter" placeholder="Cari Disini..." autocomplete="off" />
<div class="content" id="content">
<br><br><br>
<center><strong>Inventaris Barang</strong></center>
