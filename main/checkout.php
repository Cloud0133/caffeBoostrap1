...
<input type="text" name="Customer_name" placeholder="Nama Pelanggan" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/>
<input type="text" name="Customer_Telp" placeholder="Nomor Telepon Pelanggan" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/>
