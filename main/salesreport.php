					...
					<div class="span2">
	          			<div class="well sidebar-nav">
	              			<ul class="nav nav-list">
								...
								<li class="active"><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Laporan Penjualan</a></li>
	      ...
	      <?php } ?>
					<div class="span10">
						...
						<div style="margin-top: -19px; margin-bottom: 21px;">
							<button  style="float:right; width: 100px;height: 30px;top: 100px;position: relative;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Print</button></a>
						</div>
						<form action="salesreport.php" method="get" style="color:black;">
							<center>
								<strong>Dari Tanggal : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> Sampai Tanggal: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
 									<button class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" type="submit">
 										<i class="icon icon-search icon-large"></i> Cari
 									</button>
								</strong>
							</center>
						</form>
						<div class="content" id="content">
							...
							<div style="font-weight:bold; text-align:center;font-size:20px;margin-bottom: 15px; color: black;">
								Laporan Penjualan dari&nbsp;<?php echo $_GET['d1'] ?>&nbsp;sampai&nbsp;<?php echo $_GET['d2'] ?>
							</div>
							<table class="table table-bordered" border = "1" id="resultTable" data-responsive="table" style="text-align: left;">
								...
								<tbody>
									<?php
										...
										$d1=$_GET['d1'];
										$d2=$_GET['d2'];
										$result = $db->prepare("SELECT * FROM sales WHERE date BETWEEN :a AND :b ORDER by invoice_number DESC ");
